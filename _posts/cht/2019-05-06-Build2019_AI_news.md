...
![img]({{site.baseurl}}/_posts/cht/2019-05-06-Build2019_AI_news/automl_flow.jpg)
...
![img]({{site.baseurl}}/_posts/cht/2019-05-06-Build2019_AI_news/automl_vscode.jpg)

或者也可以在JupyterNotebook 上使用

![img]({{site.baseurl}}/_posts/cht/2019-05-06-Build2019_AI_news/jupyter_automl.jpg)

由於Azure AutoML 是Azure Machine Learning Services 的一環, 因此所有的訓練資料與結果都直接在Azure Machine Learning Service結合,統一的管理與顯示。

![img]({{site.baseurl}}/_posts/cht/2019-05-06-Build2019_AI_news/automl_training.jpg)

同時也可以針對個別階段的訓練去了解模型的各項參數設定與模型預測績效。

![img]({{site.baseurl}}/_posts/cht/2019-05-06-Build2019_AI_news/automl_training2.jpg)
...
![img]({{site.baseurl}}/_posts/cht/2019-05-06-Build2019_AI_news/automl_codeless1.jpg) 

然後透過Web介面設定所有的AutoML 參數, 就可以透過微軟AutoML服務來訓練模型, 訓練與測試各式模型, 找出適合的演算法與效果較好的Feature Engineering方式, 在毋需大量人力調教的狀況下, 得到一個優化過的預測模型。

![img]({{site.baseurl}}/_posts/cht/2019-05-06-Build2019_AI_news/automl_codeless2.jpg)
